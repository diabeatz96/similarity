...
export const buttonVariants = cva('active:scale-95 inline-flex items-center justify-center rounded-md text-sm font-medium transition-color focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 disabled:opacity-50 dark:focus:ring-slate-400 disable:pointer-events-none dark:focus:ring-offset-slate-900',
    {  
       variants: {
        variant: {
        ...
        size: {
            default: 'h-10 p-4',
            sm: 'h-9 p-4 rounded-md',
            lg: 'h-11 p-4 rounded-md'
        },
        defaultVariants: {
            variant: 'default',
            size: 'default'
